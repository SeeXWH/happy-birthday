...
const calmQuotes = ["Рядом с тобой даже самый громкий шторм в моей душе затихает.",
    "Твоё спокойствие — как тихая гавань, в которую всегда хочется вернуться.",
    "Ты умеешь находить правильные слова, которые приносят ясность и покой.",
    "Когда я с тобой, все тревоги мира кажутся такими незначительными.",
    "Ты мой личный островок безмятежности в этом сумасшедшем мире.",
    "С тобой я научился дышать глубже и видеть красоту в тишине.",
