...
const smileQuotes = ["Твоя улыбка — это самое яркое событие моего дня.",
    "Когда ты улыбаешься, я готов забыть обо всём на свете.",
    "В твоей улыбке больше тепла, чем в тысяче солнц.",
    "Пожалуйста, улыбайся чаще. Это делает мир лучше.",
    "Кажется, я влюбился в твою улыбку ещё до того, как влюбился в тебя.",
    "Улыбка — это твой поцелуй, который виден издалека.",
    "Даже если день был ужасным, твоя улыбка всё исправит.",
    "Помню твою улыбку, когда ты пыталась соврать, что не ела последнюю печеньку.",
    "Эта хитрая улыбка, когда ты придумала очередную шутку...",
    "Улыбаешься так, будто знаешь главный секрет Вселенной. И, возможно, так и есть.",
    "Твоя улыбка после фразы 'Ой, я случайно' бесценна.",
    "В твоей улыбке я вижу не просто радость, а целую историю.",
    "Спасибо, что делишься со мной своей улыбкой. Это самый дорогой подарок.",
    "Я понял, что дома, когда впервые увидел твою искреннюю улыбку.",
